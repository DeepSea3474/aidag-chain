...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    mainnetTarget: '2027-09-09',
    note: 'This is the live DAG ledger produced by SoulwareAI. Its final snapshot will migrate to mainnet at genesis. 1 AIDAG = 100 LSC bridge opens at mainnet.',
    stats,
