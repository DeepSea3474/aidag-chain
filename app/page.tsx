...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white overflow-x-hidden">
      ...
      <div className="relative z-10 pt-[120px] lg:pt-[140px]">
        ...
        <section id="presale" className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className={`glass rounded-2xl border ${s.color} p-6 relative`}>
                ...
                {i === 0 && (
                  <Link href="/presale" className="btn btn-primary w-full py-3 rounded-xl font-bold text-sm">
                    Buy AIDAG Now →
                  </Link>
                )}
              </div>
          ...
          <div className="text-center mt-8">
            <Link href="/presale" className="btn btn-secondary px-10 py-4 rounded-2xl font-bold text-sm inline-flex items-center gap-2">
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Open Full Presale Platform
            </Link>
          </div>
        </section>
          ...
          <div className="glass rounded-3xl border border-white/[0.07] overflow-hidden relative">
            ...
            <div className="relative px-8 md:px-16 py-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/presale" className="btn btn-primary px-10 py-4 rounded-2xl font-black text-base">{t.cta_buy}</Link>
      ...
      {/* ─── SoulwareAI Floating button ─── */}
      <Link href="/presale"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 btn-primary rounded-2xl shadow-2xl shadow-cyan-900/40 flex items-center justify-center group"
        title="Buy AIDAG">
        <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} className="group-hover:scale-110 transition-transform">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      </Link>
    </div>
